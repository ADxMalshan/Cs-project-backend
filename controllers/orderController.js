       ...
       for (let i = 0; i < body.billItems.length; i++) {
            ...
            if (productStock.stock == 0 || productStock.stock < quantity ) {
				...
				orderData.billItems[i] = {
                    ...
                    productAltName : product.altNames,
                    image : product.images[0],
                    quantity : body.billItems[i].quantity,
                    productLabeledPrice : product.labeledPrice,
                    price : product.price
                };
